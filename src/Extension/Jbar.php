    ...
    function loadjQuery()
    {
        ...
        if ($this->params->get('jquery'))
        {
            ...
            if($version->isCompatible('2.5') && $version->isCompatible( '3.0' ) ) {
                ...
                $this->getApplication()->getDocument()->addScript($jquery);
                // $this->getApplication()->getDocument()->addScriptOptions($jquery_noconflict);
                ...
                // $doc->addScript($jquery);
                // $doc->addScript($jquery_noconflict);
                // $this->getApplication()->getDocument()->addScriptOptions($jquery);
                // $this->getApplication()->getDocument()->addScriptOptions($jquery_noconflict);
            } else{
